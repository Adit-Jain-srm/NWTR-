...
const stats = [
  { value: 30000, suffix: "+ Cr", label: "Addressable Market", prefix: "₹" },
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                ...
                <div className="mt-3 h-px w-10 mx-auto bg-gradient-to-r from-transparent via-gold-500 to-transparent" />
              </div>
            ))}
          </div>
        </ScrollReveal>
