...
This project is indexed by GitNexus as **NWTR-** (3104 symbols, 4205 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
